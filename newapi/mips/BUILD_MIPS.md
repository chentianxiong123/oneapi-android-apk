...
| 版本 | 架构 | 前端 | 大小 | 编译方式 | 用途 |
|------|------|------|------|---------|------|
| **app-debug.apk** | arm64 (Go) / arm64-v8a + armeabi-v7a (APK) | 有 | 71MB | `build_from_source.ps1` → Gradle APK | Android 手机部署 |
...
| 版本 | 架构 | 前端 | 大小 | 编译方式 | 用途 |
|------|------|------|------|---------|------|
| **linux-arm64** | **arm64**（64位） | 无 | 55MB | 纯 Go 交叉编译 | 23049RAD8C 等 arm64 设备 |
| **linux-arm** | **armv7l**（32位） | 无 | 55MB | 纯 Go 交叉编译 | HaiNaSi 等 armv7 设备 |
